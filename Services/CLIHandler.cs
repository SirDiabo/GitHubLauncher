    ...
    public class CLIHandler
    {
        ...
        private async Task CheckForLauncherUpdates()
        {
            try
            {
                ...
                client.DefaultRequestHeaders.Add("User-Agent", "GitHubLauncher-CLI");
        ...
        private void ShowHelp()
        {
            ...
            Console.WriteLine("  GitHubLauncher --download ExampleApp");
            Console.WriteLine("  GitHubLauncher --run ExampleApp");
            Console.WriteLine("  GitHubLauncher -r \"Example App\"");
            Console.WriteLine();
        }
